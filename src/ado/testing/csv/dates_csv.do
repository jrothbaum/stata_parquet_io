...
//	pq save_csv → pq use_csv with exact equality.
...
//	----------------------------------------------------------------------
capture pq use_csv "`pq1'.csv", clear if(date_var >= td(05jan2020))
assert _rc == 198
...
//	----------------------------------------------------------------------
capture pq use_csv "`pq1'.csv", clear if(datetime_var >= tc(03jan2020 00:00:00))
assert _rc == 198
