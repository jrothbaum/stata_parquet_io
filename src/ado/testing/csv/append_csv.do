...
describe
tempfile t_save
pq save_csv "`t_save'.csv", replace
...
gen gamma_ = _N - _n
order beta_
pq save_csv "`t_save'_append.csv", replace

pq use_csv "`t_save'.csv", clear
gen alpha_ = _n
gen omega_ = _N - _n
order alpha_
count
pq append "`t_save'_append.csv", format(csv)
count
...
capture erase "`t_save'.csv"
capture erase "`t_save'_append.csv"
