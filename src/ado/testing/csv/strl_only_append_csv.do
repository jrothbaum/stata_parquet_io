...
pq save_csv "`part2'.csv", replace

// -----------------------------------------------------------------------
// Test 1: pq use_csv of strL-only file (already covered by debug_strl_save,
//         included here as baseline before append)
// -----------------------------------------------------------------------
pq use_csv "`part1'.csv", clear
assert _N == 3
...
// -----------------------------------------------------------------------
pq append "`part2'.csv", format(csv)
assert _N == 5
