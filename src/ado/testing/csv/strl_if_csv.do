...
//	Test that strL columns stay aligned with numeric columns when pq use_csv
...
pq save_csv "`pq1'.csv", replace


//	----------------------------------------------------------------------
//	Test 1: if filter — load only rows where id > 10
//	----------------------------------------------------------------------
pq use_csv "`pq1'.csv", clear if(id > 10)
...
//	----------------------------------------------------------------------
pq use_csv "`pq1'.csv", clear if(inlist(id, 3, 7, 15))
...
//	----------------------------------------------------------------------
pq use_csv "`pq1'.csv", clear in(5/14)
...
pq append "`pq1'.csv", if(id > 10) format(csv)
assert _N == 20
