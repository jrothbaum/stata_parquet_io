...
//	Test that strL columns stay aligned with numeric columns when pq use_spss
...
//	----------------------------------------------------------------------
pq use_spss "`pq1'.sav", clear if(id > 10)
...
//	----------------------------------------------------------------------
pq use_spss "`pq1'.sav", clear if(inlist(id, 3, 7, 15))
...
//	----------------------------------------------------------------------
pq use_spss "`pq1'.sav", clear in(5/14)
...
pq append "`pq1'.sav", if(id > 10) format(spss)
assert _N == 20
