...
pq save_spss "`roundtrip'.sav", replace
pq use_spss "`roundtrip'.sav", clear
...
local part1 "`roundtrip'_part1.sav"
local part2 "`roundtrip'_part2.sav"
pq use_spss "`roundtrip'.sav", clear in(1/250)
pq save_spss "`part1'", replace

pq use_spss "`roundtrip'.sav", clear in(251/500)
pq save_spss "`part2'", replace

pq use_spss "`roundtrip'_part*.sav", clear
assert _N == 500
