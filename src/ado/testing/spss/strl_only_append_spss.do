...
pq save_spss "`part1'.sav", replace
...
pq save_spss "`part2'.sav", replace

// -----------------------------------------------------------------------
// Test 1: pq use_spss of strL-only file (already covered by debug_strl_save,
//         included here as baseline before append)
// -----------------------------------------------------------------------
pq use_spss "`part1'.sav", clear
assert _N == 3
...
// -----------------------------------------------------------------------
pq append "`part2'.sav", format(spss)
assert _N == 5
