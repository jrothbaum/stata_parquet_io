...
//! Raw FFI bindings to the Stata Plugin API.
//!
//! This crate provides low-level bindings to the Stata Plugin API,
//! intended for use by higher-level Rust crates implementing Stata plugins.

// Include the bindings generated by bindgen
include!(concat!(env!("OUT_DIR"), "/bindings.rs"));

#[allow(dead_code)]
const _CHECK_SD_PLUGINVER: () = {
    // This is a compile-time check to see if SD_PLUGINVER is defined
    // If it's not, this will cause a compilation error which we handle below
};
